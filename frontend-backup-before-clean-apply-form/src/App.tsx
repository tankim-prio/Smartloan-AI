...
function ReviewPage() {
  ...
  const loadApplications = async () => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Failed to load review applications.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const loadDetail = async (submissionId: number) => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Failed to load application details.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const sendDecision = async (submissionId: number, decision: "approved" | "refused") => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Failed to update decision.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const openLoanApplicationPdf = async (submissionId: number) => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Loan Application PDF could not be opened.");
    } finally {
      setLoading(false);
    }
  };
...
const mlopsFetch = async (url: string, options: RequestInit = {}) => {
  ...
  const loadMlopsData = async () => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Failed to load MLOps data.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const uploadModelPackage = async () => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Model upload failed.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const deployModel = async (modelId: number) => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Model deploy failed.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const setActiveModel = async (modelId: number) => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Set active failed.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const loadArtifactPreview = async (modelId: number) => {
    try {
      ...
      setMessage(error instanceof Error ? error.message : "Artifact preview failed.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const loadHealthAndContext = async () => {
    try {
      ...
      setHealth({
        ollama_ready: false,
        default_model: model,
        message: error instanceof Error ? error.message : "AI Pilot health check failed.",
      });
    }
  ...
  const askAI = async (customQuestion?: string) => {
    ...
    try {
      ...
      setMessages((previous) => [
        ...
        {
          role: "assistant",
          text: error instanceof Error ? error.message : "AI Pilot request failed.",
          source: "error",
        },
      ]);
    } finally {
...
function CreateAccountPage() {
  ...
  const loadAccounts = async () => {
    try {
      ...
      setError(caughtError instanceof Error ? caughtError.message : "Could not load accounts.");
    }
  };
  ...
  const updateStatus = async (account: StaffAccount, status: string) => {
    try {
      ...
      setError(caughtError instanceof Error ? caughtError.message : "Status update failed.");
    }
  };
